...
JNIEXPORT jlong JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_createEncoder
...
JNIEXPORT jlong JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_createDecoder
...
JNIEXPORT jint JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_encode
...
JNIEXPORT jint JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_decode
...
//    LOGD("nShortSize:%d",nShortSize);
    int nRet = opus_decode(pDec, (unsigned char *) pBytes, nByteSize, pSamples, nShortSize, 0);
    env->ReleaseShortArrayElements(samples, pSamples, 0);
    env->ReleaseByteArrayElements(bytes, pBytes, 0);
    return nRet;
}
JNIEXPORT void JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_destroyEncoder
...
JNIEXPORT void JNICALL Java_cn_ykuav_yikushoutapp_util_OpusUtils_destroyDecoder
